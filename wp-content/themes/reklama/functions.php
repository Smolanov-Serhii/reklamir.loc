<?php
/**
 * Reklama functions and definitions
 *
 ...
 */
function reklama_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Reklama, use a find and replace
		* to change 'reklama' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'reklama', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'main-menu' => esc_html__( 'Основное меню', 'reklama' ),
		)
	);
...
//		'custom-background',
//		apply_filters(
//			'reklama_custom_background_args',
//			array(
